package com.snapit.test.repository;

import com.snapit.test.EntertainingWalrusApp;
import com.snapit.test.config.Constants;
import com.snapit.test.config.audit.AuditEventConverter;
import com.snapit.test.domain.PersistentAuditEvent;
...
import static com.snapit.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
